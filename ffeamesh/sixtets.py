...
def convert_mrc_to_6tets(input_file, output_file, threshold, ffea_out, vtk_out, verbose, progress):
    ...
    with mrcfile.mmap(input_file, mode='r+') as mrc:
        nvoxel, points, connectivities_final = voxels_to_6_tets_plain(mrc, threshold, progress)
...
def voxels_to_6_tets_plain(mrc, threshold, progress):
    """
    Thresholds voxels and converts them all into 6 tetrohedrons.
    Args:
