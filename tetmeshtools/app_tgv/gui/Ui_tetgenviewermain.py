...
class Ui_TetgenViewerMain(object):
    def setupUi(self, TetgenViewerMain):
        ...
        TetgenViewerMain.resize(691, 550)
        TetgenViewerMain.setTabShape(QtWidgets.QTabWidget.TabShape.Rounded)
        self.centralwidget = QtWidgets.QWidget(parent=TetgenViewerMain)
        ...
        self._tetViewer = TetViewer(parent=self.groupBox)
        self._tetViewer.setObjectName("_tetViewer")
        self.verticalLayout_2.addWidget(self._tetViewer)
        self._controlsGroup = QtWidgets.QGroupBox(parent=self.groupBox)
        ...
        self._showTetBox = QtWidgets.QCheckBox(parent=self._controlsGroup)
        ...
        self._surfaceButton = QtWidgets.QCheckBox(parent=self._controlsGroup)
        ...
        self._surfaceLatticeButton = QtWidgets.QCheckBox(parent=self._controlsGroup)
        ...
        self._thicknessBox = QtWidgets.QSpinBox(parent=self._controlsGroup)
        ...
        self._ctrTetButton = QtWidgets.QPushButton(parent=self._controlsGroup)
        ...
        self._ctrMeshButton = QtWidgets.QPushButton(parent=self._controlsGroup)
        ...
        self.label_2 = QtWidgets.QLabel(parent=self._controlsGroup)
        self.label_2.setObjectName("label_2")
        self.horizontalLayout.addWidget(self.label_2)
        self._rotXSlider = QtWidgets.QSlider(parent=self._controlsGroup)
        ...
        self._rotXSlider.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self._rotXSlider.setObjectName("_rotXSlider")
        self.horizontalLayout.addWidget(self._rotXSlider)
        self.verticalLayout.addLayout(self.horizontalLayout)
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.label_3 = QtWidgets.QLabel(parent=self._controlsGroup)
        self.label_3.setObjectName("label_3")
        self.horizontalLayout_2.addWidget(self.label_3)
        self._rotYSlider = QtWidgets.QSlider(parent=self._controlsGroup)
        self._rotYSlider.setEnabled(True)
        self._rotYSlider.setMaximum(360)
        self._rotYSlider.setOrientation(QtCore.Qt.Orientation.Horizontal)
        ...
        self._tetsTableWidget = QtWidgets.QTableWidget(parent=self.groupBox_2)
        self._tetsTableWidget.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.SingleSelection)
        self._tetsTableWidget.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectionBehavior.SelectRows)
        ...
        self._totalVolLabel = QtWidgets.QLabel(parent=self.groupBox_5)
        ...
        self._totalAreaLabel = QtWidgets.QLabel(parent=self.groupBox_5)
        ...
        self.menubar = QtWidgets.QMenuBar(parent=TetgenViewerMain)
        ...
        self.statusbar = QtWidgets.QStatusBar(parent=TetgenViewerMain)
        self.statusbar.setObjectName("statusbar")
        TetgenViewerMain.setStatusBar(self.statusbar)
        self._actionLoad = QtGui.QAction(parent=TetgenViewerMain)
        self._actionLoad.setObjectName("_actionLoad")
        self._actionExit = QtGui.QAction(parent=TetgenViewerMain)
        self._actionExit.setObjectName("_actionExit")
        self._actionSaveImage = QtGui.QAction(parent=TetgenViewerMain)
        self._actionSaveImage.setObjectName("_actionSaveImage")
        self._actionSaveTetData = QtGui.QAction(parent=TetgenViewerMain)
        self._actionSaveTetData.setObjectName("_actionSaveTetData")
        self._actionSaveSetup = QtGui.QAction(parent=TetgenViewerMain)
        self._actionSaveSetup.setObjectName("_actionSaveSetup")
        self._actionLoadSetup = QtGui.QAction(parent=TetgenViewerMain)
        self._actionLoadSetup.setObjectName("_actionLoadSetup")
        self._actionPerspective = QtGui.QAction(parent=TetgenViewerMain)
        self._actionPerspective.setObjectName("_actionPerspective")
        self._actionOrthogonal = QtGui.QAction(parent=TetgenViewerMain)
        self._actionOrthogonal.setObjectName("_actionOrthogonal")
        self._actionBlackBackground = QtGui.QAction(parent=TetgenViewerMain)
        self._actionBlackBackground.setObjectName("_actionBlackBackground")
        self._actionWhiteBackground = QtGui.QAction(parent=TetgenViewerMain)
        self._actionWhiteBackground.setObjectName("_actionWhiteBackground")
        self._actionGrayBackground = QtGui.QAction(parent=TetgenViewerMain)
        ...
        self._showTetBox.stateChanged['int'].connect(self._tetViewer.show_current_tet) # type: ignore
